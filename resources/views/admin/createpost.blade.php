...
@section("content")
	...
	<div class="content-wrapper">
        ...
        @endif
            ...
            <!-- /.box-header -->
            <!-- form start -->
            {{ Form::open(["route" => "admin.posts.store" , "method" => "post" ,"role" => "form" , "files" => true]) }}
              <div class="box-body">
                <div class="form-group">
                 {{ Form::label("title" , "Title") }}
                 {{ Form::text("title" , "" ,["class" => "form-control" , "id" => "title_post" , "value" => "" , "onkeyup" => "slug_url()"]) }}
                </div>
                <div class="form-group">
                {{ Form::label("slug" , "Slug") }}
                {{ Form::text("slug" , "" ,["class" => "form-control" , "id" => "slug_post"]) }}
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                	<textarea id="create_post" name="content"></textarea>
                </div>
                <div class="form-group">
